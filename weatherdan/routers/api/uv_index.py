...
def refresh_readings(*, force: bool = False) -> None:
    ...
    with db_session:
        ...
        history_readings = ecowitt.get_history_readings(
            ...
            start_date=settings.last_updated.uv_index,
        )
        ...
        # endregion
        # region Live reading
        live_reading = ecowitt.get_live_reading(device=device.mac, category=Category.UV_INDEX)
        if live_reading:
        ...
        # endregion
    settings.last_updated.uv_index = datetime.now()  # noqa: DTZ005
    settings.save()
